...
alias kgsargos="kubectl -n argocd get secret argocd-initial-admin-secret  -o jsonpath="{.data.password}" | base64 -d"

alias kpfargos="kubectl port-forward svc/argocd-server 8080:80 -n argocd"
